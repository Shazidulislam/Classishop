...
const SubMenu = () => {
  return (
    <ul className="absolute left-0 top-full mt-2 w-32 bg-white shadow-lg rounded-md py-2 opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-300">
      ...
      <li className="relative group/girls">
        ...
        >
          Girls
           ...
           <div className="absolute top-0 left-full w-32 bg-white shadow-lg rounded-lg py-2 opacity-0 invisible group-hover/girls:opacity-100 group-hover/girls:visible transition-all duration-300">
            <ul>
                <li >
