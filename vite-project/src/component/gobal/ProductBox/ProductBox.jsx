...
import popular from "../../../assets/images/slider/popular.webp"
...
const ProductBox = () => {
  return (
    <div className="flex flex-col justify-between border-2 border-gray-100 cursor-pointer  rounded shadow-lg p-4 w-52 ">
      {/* Product Image */}
      <div className="flex-1 flex justify-center items-center overflow-hidden group relative">
        ...
        />
        <p className="absolute left-1  text-center top-0 p-1 bg-[#ff5252] text-white leading-4  rounded-full text-[12px] aspect-square">10%</p>
        <div className="absolute flex flex-col w-16 -right-8 gap-3  top-0 z-20 -translate-y-full group-hover:translate-y-0 transition-transform duration-300">
      ...
      {/* Add to Cart Button */}
      <button className="text-[#ff5252]  px-5 py-2 flex items-center justify-center border-2 border-[#ff5252] hover:bg-black hover:text-white w-full transition duration-300 rounded hover:border-black cursor-pointer mb-1"> <IoCartOutline size={20 } className="font-bold" /> Add To Cart</button>
    </div>
  );
};
